																		...
																		<tbody><tr>
																			...
																			<tr>
																				<td style="text-align:left;font-size:16px;color:#4c505d;line-height:20px" >
																					<p style=" font-family:Arial,Tahoma,Helvetica,sans-serif;color:#4c505d;margin-top:0px;font-family:Arial,Tahoma,Helvetica,sans-serif;color:#4c505d;">You have submitted a request to reset the password. Please use the below code to reset the password</p>
