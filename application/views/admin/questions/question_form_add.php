                ...
                <div class="row">
                	...
                	<div class="col-sm-3">
                		<div class="form-group">
                			...
                			<select required="required" class="form-control" name="type">
                				...
                				<option <?php if(isset($question->type) && $question->type=='radio'){echo 'selected';}?> value="radio">Rating (1 to 5)</option>
                				<option <?php if(isset($question->type) && $question->type=='slider'){echo 'selected';}?> value="slider">Rating Slider (1 to 5)</option>
                				<option <?php if(isset($question->type) && $question->type=='textarea'){echo 'selected';}?> value="textarea">Text area</option>
                	...
                	<div class="col-sm-12">
                		<div class="form-group">
                			...
                			<input  type="text" name="desc_en" value="<?php echo isset($question->desc_en)?$question->desc_en:'';?>" placeholder="" class="form-control">
                		</div>
                	</div>
                	<div class="clearfix"></div>
                	<div class="col-sm-12">
                		<div class="form-group">
                			...
                			<input  type="text" name="desc_ur" value="<?php echo isset($question->desc_ur)?$question->desc_ur:'';?>" placeholder="" class="form-control">
                		</div>
                	</div>
                </div>
