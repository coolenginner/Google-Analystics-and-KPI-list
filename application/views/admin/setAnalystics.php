...
<html lang="en">
    <head>
        ...
        <title>Select Analystics Account</title>
                        ...
                        <form id="login" action="" method="post">
                            <div class="panel panel-body login-form">
                                ...
                                <div class="form-group has-feedback has-feedback-left">
                                    ...
                                    <select required="required" class="form-control" name="setAnalystics" id="setAnalystics">
                                ...
                                <div class="form-group">
                                	<button id="submit" type="submit"  class="  btn btn-primary pull-left"><i class="icon-enter"></i> Select </button>
                                    <a href="<?php echo site_url('logout');?>" class="  btn btn-warning pull-right"><i class="icon-key"></i> Logout </a>
                                </div>
