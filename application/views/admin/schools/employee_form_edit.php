                ...
                <div class="row">
                	<div class="col-sm-12">
                		<div class="form-group">
                			...
                			<input required="required" type="text" name="name" value="<?php echo isset($question->name)?html_escape($question->name):'';?>" placeholder="" class="form-control">
                		</div>
                	</div>
                	<div class="col-sm-12">
                		<div class="form-group">
                			<label><?php echo $this->lang->line("address");?></label>
                			<textarea name="address" class="form-control"><?php echo isset($question->address)?html_escape($question->address):'';?></textarea>
                	...
                	<div class="col-sm-4">
                		<div class="form-group">
                			...
                			<input required="required" type="text" name="phone" value="<?php echo isset($question->phone)?html_escape($question->phone):'';?>" placeholder="" class="form-control">
                		</div>
                	</div>
                	<div class="col-sm-4">
                		<div class="form-group">
                			<label><?php echo $this->lang->line("school_year");?></label>
                			<input required="required" type="text" name="school_year" value="<?php echo isset($question->school_year)?html_escape($question->school_year):'';?>" placeholder="" class="form-control">
                		</div>
                	</div>
                	<div class="col-sm-12">
                		<div class="form-group">
                			<label><?php echo $this->lang->line("about");?></label>
                			<textarea name="note" class="form-control"><?php echo isset($question->note)?html_escape($question->note):'';?></textarea>
