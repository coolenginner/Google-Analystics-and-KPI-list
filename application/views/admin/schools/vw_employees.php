...
<div class="panel panel-flat">
        ...
        <h5 class="panel-title"><?php echo isset($page_title)?$page_title:'Dashboard';?>
        	<div class="pull-right">
        		<div class="heading-btn-group">
        			...
        			<?php } ?>
        			<!-- <a href="<?php echo site_url('admin/schools/import'); ?>" class="btn btn-sm btn-primary "><i class="fa fa-plus"></i> Import</a>
        			<a href="<?php echo site_url('admin/schools/archived'); ?>" class="btn btn-sm btn-primary "><i class="fa fa-download"></i> Archived</a> -->
        			<a href="javascript:;" class="btn btn-sm btn-danger bulk_delete_btn"><i class="fa fa-trash"></i> <?php echo $this->lang->line("delete");?></a>
        		</div>
    ...
    <table class="table " id="example">
        ...
        <thead>
            <tr>
                <th width="5%"  class="no-sort"> <?php echo $this->lang->line("sr_number");?></th>
                
                <th  width="35%"><?php echo $this->lang->line("name");?></th>
                <!-- <th  width="20%">Address</th> -->
                <th  width="15%"><?php echo $this->lang->line("school_year");?></th>
   ...
   $(document).ready(function() {
    table = $('#example').DataTable( {
        ...
        "serverSide": true,
         "order": [],
        "ajax": {
            "url": "<?php echo site_url('admin/schools/ajax_list');?>",
            "type": "POST",
    ...
    $(document).on('click','#Delete_Joke',function(){
    	...
    	$.ajax({
                url: "<?php echo base_url(); ?>admin/schools/delete_school",
                type: "POST",
