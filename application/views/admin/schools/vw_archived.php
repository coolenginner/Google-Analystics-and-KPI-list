...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Archived Participants
        	<div class="pull-right">
        		<div class="heading-btn-group">
        			...
        			<a href="javascript:;" class="btn btn-sm btn-primary bulk_delete_btn"><i class="fa fa-download"></i> Restore</a>
        		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				Are you sure you want to restore this Participant?
			</div>
...
<script>
   ...
   $(document).ready(function() {
    ...
    $(document).on('click','#Delete_Joke',function(){
    	...
    	$.ajax({
                url: "<?php echo base_url(); ?>admin/employees/restore_employee",
                type: "POST",
