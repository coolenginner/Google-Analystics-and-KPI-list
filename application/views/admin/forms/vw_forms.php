        ...
        <h5 class="panel-title">Forms
        	<div class="pull-right">
        		<div class="heading-btn-group">
        			...
        			<a href="<?php echo site_url('admin/forms/archived'); ?>" class="btn btn-sm btn-primary "><i class="fa fa-download"></i> Archived</a>
...
<script>
   ...
   $(document).ready(function() {
    ...
    $(document).on('click','#Delete_Joke',function(){
    	...
    	$.ajax({
                url: "<?php echo base_url(); ?>admin/forms/delete_form",
                type: "POST",
