...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/css/custom.css?v=1" rel="stylesheet" type="text/css">
        ...
        <div class="navbar navbar-default header-highlight">
            ...
            <div class="navbar-collapse collapse" id="navbar-mobile">
                <ul class="nav navbar-nav">
                    <li><a class="sidebar-control sidebar-main-toggle m-t-sm hidden-xs"><i class="icon-paragraph-justify3"></i></a></li>


                </ul>


                <ul class="nav navbar-nav navbar-right m-t-sm">
                    ...
                    ?>
                    <li><a href="<?php echo base_url() . $c_name; ?>/logout"><i class="icon-switch2"></i> Logout</a></li>
