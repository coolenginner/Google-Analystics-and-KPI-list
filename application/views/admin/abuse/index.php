...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Abuse List</h5>
    </div>
    <?php
    ...
    <table class="table " id="example">
        <thead>
            <tr>
                <th  class="no-sort">Abuse Number</th>
                <th>Joke</th>
                <th>Posted By</th>
                <th>Language</th>
   ...
   $(document).ready(function() {
    table = $('#example').DataTable( {
        ...
        "serverSide": true,
         "order": [],
        "ajax": {
            "url": "<?php echo site_url('admin/abuse/ajax_list');?>",
            "type": "POST"
        },
    ...
    $(document).on('click','#Delete_Joke',function(){
    	...
    	$.ajax({
                url: "<?php echo base_url(); ?>admin/abuse/delete_joke",
                type: "POST",
