                ...
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        ...
                        <form id="login" action="" method="post">
                            <div class="panel panel-body login-form">
                                ...
                                <div class="form-group has-feedback has-feedback-left">
                                    <input autofocus type="email" value="<?php echo $this->input->post('email'); ?>" class="form-control" name="email" placeholder="Email">
                                ...
                                <div class="form-group">
                                    <button id="submit" type="submit" class="btn btn-primary btn-block">Sign in <i class="icon-circle-right2 position-right"></i></button>
                                </div>
                        ...
                        <div class="footer text-muted">
                            &copy; 2018. <a href="#"><?php echo APP_NAME;?></a>
                        </div>
                        <!-- /footer -->
